...
class LatCostModel:
    def __init__(self, device_names=[], cost_model_store_path: str = "./leanred_cost_model") -> None:
            ...
            for shard in shards:
                for h1, h2 in h_pairs.values:
                    for bit in bits:
                        ...
                        if os.path.exists(os.path.join(self.cost_model_store_path, model_name)):
                            self.regression_models[device_name][model_name] = model = joblib.load(os.path.join(self.cost_model_store_path, model_name))
            ...
            for shard in shards:
                for h1, h2 in h_pairs.values:
                    for bit in bits:
                        ...
                        if store:
                            joblib.dump(model, os.path.join(self.cost_model_store_path, f'{model_name}'))
