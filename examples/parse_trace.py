...
folder_path = "/opt/tiger/Saber/llm_pq_v2/examples/tmp/vllm_profile_parsed/Llama_3.2_1B_Instruct_sharded-gptq-4-1-pt.trace.json"
...
modules_names = ['VocabParallelEmbedding', 'LlamaDecoderLayer', 'LogitsProcessor']
