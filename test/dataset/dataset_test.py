...
ds_cnn.distribution()
ds_cnn.dump_n_serving_prompts(512, '/opt/tiger/Saber/llm_pq_v2/test/dataset/cnn.pkl', max_seq_len=max_seq_len)
...
ds_loo.distribution()
ds_loo.dump_n_serving_prompts(16, '/opt/tiger/Saber/llm_pq_v2/test/dataset/loo.pkl', max_seq_len=max_seq_len)
