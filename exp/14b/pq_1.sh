# python3 /yourpath//llm_pq_v2/test/dataset/dataset_test.py --model /yourpath//llm_pq_v2/exp/14b/tmp/Qwen2.5-14B-Instruct-ada-dummy
...
MODEL=/yourpath//llm_pq_v2/exp/14b/tmp/Qwen2.5-14B-Instruct-ada-dummy
vllm serve $MODEL \
    --load-format dummy  \
    --quantization llmpq \
