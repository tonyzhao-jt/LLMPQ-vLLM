...
#     --model $MODEL_ID \
#     --dataset-name llmpq \
#     --dataset-path /opt/tiger/Saber/llm_pq_v2/test/dataset/cnn.pkl  > benchmark_2_pq_cnn.log 2>&1 
...
python /opt/tiger/Saber/llm_pq_v2/benchmarks/bench_serve.py \
    ...
    --model $MODEL_ID \
    --dataset-name llmpq \
    --dataset-path /opt/tiger/Saber/llm_pq_v2/test/dataset/loo.pkl  > benchmark_2_pq_loo_test.log 2>&1 