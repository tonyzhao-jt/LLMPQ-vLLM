...
<<<<<<<< HEAD:exp/70b/A100/quantizer_pq.py
    ...
    num_8bit = 0
    num_8_tc_bit = 0
    bit_pack = ",".join(["8-tc"] * 10 ) + ',' + ",".join(["4"] * 30)
    bit_pack_2 = ",".join(["8-tc"] * 10 ) + ',' + ",".join(["4"] * 30) 
    num_16bit = 0
    bit_packs = [bit_pack, bit_pack_2]
========
    # local_path = "./tmp/Llama-3.3-70B-ada"
    MODEL='meta-llama/Llama-2-70b-chat-hf'
    local_path = "./tmp/Llama-2-70B-ada"
    ...
    num_16bit = 12
    bit_packs = []
>>>>>>>> a675fb2abdb82fbb55ddda20a556c843f4a347d2:exp/70b/v100/quantizer_pq.py
    if num_4bit > 0:
