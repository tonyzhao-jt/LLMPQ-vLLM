...
MODEL_ID=/yourpath//llm_pq_v2/exp/70b/tmp/Llama-3.3-70B-4bit
TYPE='het'
# TYPE='uniform_tp'
========
MODEL_ID=/yourpath//llm_pq_v2/exp/70b/tmp/Llama-2-70B-8bit
TYPE='het'
TYPE='uniform_tp'
...
#     --model $MODEL_ID \
#     --dataset-name llmpq \
#     --dataset-path /yourpath//llm_pq_v2/test/dataset/loo.pkl  > benchmark_2_$TYPE_loo.log 2>&1
